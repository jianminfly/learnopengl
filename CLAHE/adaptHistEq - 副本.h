...
#pragma region declare
    ...
    char* v103; // edi
    char* v104; // ebx
    int v105; // [esp+18h] [ebp-48h]
    int v106; // [esp+24h] [ebp-3Ch]
    int v107; // [esp+24h] [ebp-3Ch]
    int v108; // [esp+24h] [ebp-3Ch]
    int v109; // [esp+24h] [ebp-3Ch]
    int v110; // [esp+24h] [ebp-3Ch]
    int v111; // [esp+24h] [ebp-3Ch]
...
#pragma endregion
    ...
    v127 = xValue * v10;
    v133 = yValue * v11;
    if (xValue * v10 != width || yValue * v11 != height)
    {
        v88 = 4 * ((24 * v127 + 31) / 32);
        v89 = (v133 - height) / 2;
        v90 = (v127 - width) / 2;
        ...
        if (v89 && v127 > 0)
        {
            ...
            do
            {
                ...
                if (v97 > 0)
                {
                    v101 = &v157[v88 * (v89 + height)];
                    v102 = &v157[v88 * (v89 + height - 1)];
                    v111 = v162;
                    do
                    {
                        *v101 = *v102;
        ...
        if (height > 0)
        {
            v103 = (char*)&v157[3 * v90 + v88 * v89];
            v104 = (char*)pData;
            v165 = height;
            do
            {
                memcpy(v104, v103, stride);
                v104 += stride;
                v103 += v88;
                --v165;
            } while (v165);
    ...
    else
    {
        ...
        v13 = (signed int)_ceil((float)((float)((float)((float)v11 * (float)v10) * (float)v12) * 0.00390625));
        v163 = v13 + (signed int)((double)(v158 * v11 * v12 - v13) * *(double*)&limit);
