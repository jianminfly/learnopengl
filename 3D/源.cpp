  ...
  glm::vec3(-1.3f,  1.0f, -1.5f)
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            model = glm::rotate(model, (float)glm::sin(glfwGetTime()*(i+1)), glm::vec3(1.0f, 0.0f, 0.0f));
            ...
            glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(projection * view * model));
