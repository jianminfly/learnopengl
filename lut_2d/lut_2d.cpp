...
std::string u162u8(const std::wstring& s) {
    std::string v{};
    utf8::utf16to8(s.cbegin(), s.cend(), std::back_inserter(v));
    return v;
}
...
int wmain(int argc, wchar_t* argv[])
{
    ...
    std::string fileName = u162u8(fileNameIn);// GbkToUtf8(fileNameIn.c_str());
    ...
    // ------------------------------------
    Shader ourShader("base.vs", "people-light.frag");
