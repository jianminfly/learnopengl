...
int main()
{
    ...
    // ------------------------------------
    Shader chromaShader("base.vs", "./lansong2/chromkey.frag");
    Shader erodeShader("base.vs", "./lansong2/erode.frag");
    Shader DilateShader("base.vs", "./lansong2/Dilate.frag");
    Shader blurShader("base.vs", "./lansong2/blur.frag");
    Shader despillShader("base.vs", "./lansong2/despill.frag");
    Shader mixShader("base.vs", "./lansong2/mix.frag");
    ...
    unsigned int texture1;
    {
        ...
        unsigned char* data = stbi_load("C:\\Users\\EDZ\\Desktop\\shader editor\\hair.JPG", &width, &height, &nrChannels, 4);
        if (data)
        {
    ...
    blurShader.setInt("texture2", 1);

    despillShader.use();
    despillShader.setInt("texture1", 0);
    despillShader.setInt("texture2", 1);

    mixShader.use();
    mixShader.setInt("texture1", 0);
    mixShader.setInt("texture2", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glClear(GL_COLOR_BUFFER_BIT);
        DilateShader.use();
        DilateShader.setInt("texture1", 0);
        //ourShader.setFloatv2("samplingRadius", 0, Radius);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
        glBindFramebuffer(GL_READ_FRAMEBUFFER, 0);
        glBindFramebuffer(GL_DRAW_FRAMEBUFFER, framebuffer);
